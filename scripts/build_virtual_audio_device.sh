...
echo "Built:"
echo "  $PROJECT_DIR/.derived/Build/Products/Debug/OnBlastVirtualAudioPlugIn.driver"
echo "  $PROJECT_DIR/.derived/Build/Products/Debug/OnBlastVirtualAudioXPC.xpc"
