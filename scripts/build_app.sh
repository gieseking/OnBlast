...
APP_NAME="MediaButtonInterceptor"
...
APP_IDENTIFIER="com.gieseking.MediaButtonInterceptor"
APP_ICON="$ROOT_DIR/App/AppIcon.icns"
VIRTUAL_AUDIO_PRODUCT_DIR="$ROOT_DIR/VirtualAudioDevice/.derived/Build/Products/Debug"
VIRTUAL_AUDIO_DRIVER_PRODUCT="$VIRTUAL_AUDIO_PRODUCT_DIR/MediaButtonVirtualAudioPlugIn.driver"
VIRTUAL_AUDIO_XPC_PRODUCT="$VIRTUAL_AUDIO_PRODUCT_DIR/MediaButtonVirtualAudioXPC.xpc"
